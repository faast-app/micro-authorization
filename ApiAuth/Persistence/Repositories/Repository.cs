...
internal abstract class FintecRepository<TEntity> : IFintecRepository<TEntity>
    where TEntity : Entity
{
    protected readonly FintecDbContext DbContext;

    protected FintecRepository(FintecDbContext dbContext)
    {
        DbContext = dbContext;
    }
